package com.dswey.dsim.fixtures;

import com.dswey.dsim.model.Dialog;
import com.dswey.dsim.model.Message;
...
public final class DialogsFixtures extends FixturesData {
    ...
    public static Dialog getDialog() {
        ...
        User user = new User(getRandomId(), getRandomName(), getRandomAvatar(), getRandomBoolean());
        Message message = new Message(getRandomId(), user, getRandomMessage(), calendar.getTime());
        users.add(user);
        return new Dialog(getRandomId(), user.getName(), getRandomAvatar(), users, message, 1);
    }
